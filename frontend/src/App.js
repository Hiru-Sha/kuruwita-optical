...
function Protected({ children }) {
  ...
  if (loading) return (
    <div style={{
      ...
      height:'100vh', fontFamily:"'Inter','DM Sans',sans-serif",
      ...
      <div style={{ fontSize:13, fontWeight:500 }}>Loading Kuruwita Optical...</div>
    </div>
  );
        ...
        <Routes>
          ...
          <Route path="/" element={<Protected><Layout /></Protected>}>
            ...
            <Route path="calculator" element={
              <Suspense fallback={<div>Loading...</div>}><LensCalculator /></Suspense>
            }/>
