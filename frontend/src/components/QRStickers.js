...
// MIDDLE strip (25×12mm): wraps around arm — only part with glue
// BOTTOM box (25×25mm): brand/model/info — hangs other side
// No fold needed — just wrap strip around arm, slide off to remove
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        borderBottom:'0.2mm solid #e5e7eb',
      }}>
        {qrUrl
