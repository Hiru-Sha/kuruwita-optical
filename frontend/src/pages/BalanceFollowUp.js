    ...
    <div style={{ background:C.surface, border:`1px solid ${C.border}`, borderRadius:14, overflow:'hidden', marginBottom:10 }}>
      ...
      <div style={{ display:'flex', alignItems:'center', gap:14, padding:'14px 16px', cursor:'pointer' }}
        ...
        <div style={{ flexShrink:0, textAlign:'right' }}>
          <div style={{ fontFamily:'var(--font-display)', fontSize:18, fontWeight:700, color:C.danger }}>
            {fmt(totalBalance)}
          </div>
      ...
      <div style={{ padding:'0 16px 12px', display:'flex', gap:8, flexWrap:'wrap' }}>
        ...
        <button onClick={()=>setExpanded(e=>!e)}
          style={{ padding:'9px 14px', background:C.surface, color:C.muted, border:`1.5px solid ${C.border}`, borderRadius:9, fontSize:12, fontWeight:600, cursor:'pointer', fontFamily:'inherit', marginLeft:'auto' }}>
              ...
              <div key={order.id} style={{ padding:'12px 16px', borderBottom:i<orders.length-1?`1px solid ${C.cream}`:undefined, display:'flex', gap:12, alignItems:'flex-start' }}>
                ...
                <div style={{ flex:1, minWidth:0 }}>
                  <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:4, flexWrap:'wrap', gap:6 }}>
                    ...
                    <span style={{ fontFamily:'var(--font-display)', fontSize:16, fontWeight:700, color:C.danger }}>
  ...
  return (
    <div style={{ fontFamily:'var(--font-body)' }}>
      ...
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:4, flexWrap:'wrap', gap:10 }}>
        <div>
          <h1 style={{ fontFamily:'var(--font-display)', fontSize:24, color:C.navy, margin:0 }}>💰 Balance Follow-up</h1>
      ...
      <div style={{ display:'flex', gap:8, marginBottom:16, flexWrap:'wrap' }}>
        <input value={search} onChange={e=>setSearch(e.target.value)}
          ...
          style={{ flex:1, minWidth:180, padding:'9px 14px', border:`1.5px solid ${C.border}`, borderRadius:9, fontSize:13, fontFamily:'inherit', outline:'none', background:C.surface }}/>
      ...
      {loading
        ...
        : !filtered.length
          ? <div style={{ textAlign:'center', padding:40, color:C.muted, background:C.surface, borderRadius:14, border:`1px solid ${C.border}` }}>
