          ...
          <div key={lbl}>
            ...
            <div style={{ display:'flex', gap:4 }}>
              ...
              <input value={val.replace(/[^0-9.]/g,'')} onChange={handler} placeholder="0.00"
                style={{ flex:1, padding:'8px 10px', border:`1.5px solid ${C.border}`, borderRadius:8, fontSize:14, fontFamily:'inherit', outline:'none', background:C.surface, color:C.navy }}/>
            </div>
          </div>
        ))}
      </div>
    ...
    return (
      <div style={{ minHeight:'100vh', background:'linear-gradient(135deg,#0f1f3d 0%,#1a3260 100%)',
        ...
        <div style={{ width:'100%', maxWidth:420 }}>
          ...
          {selectedLens && (
            <div style={{ background:C.surface, borderRadius:18, padding:20, marginBottom:16 }}>
    ...
    <div style={{ fontFamily:"'Inter','Inter','DM Sans',sans-serif", maxWidth:620, margin:'0 auto' }}>
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:16 }}>
        <div>
          ...
          <h1 style={{ fontFamily:'var(--font-display)', fontSize:22, color:C.navy, margin:0 }}>Lens Calculator</h1>
        </div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, marginBottom:10 }}>
            <div>
              ...
              <select value={addForm.lens_type} onChange={e=>setAddForm(f=>({...f,lens_type:e.target.value}))}
                style={{ width:'100%', padding:'9px 10px', border:`1.5px solid ${C.border}`, borderRadius:8, fontSize:13, fontFamily:'inherit', outline:'none', background:C.surface }}>
            ...
            <div>
              ...
              <input type="number" value={addForm.buy_price} onChange={e=>setAddForm(f=>({...f,buy_price:e.target.value}))} placeholder="e.g. 1200"
                style={{ width:'100%', padding:'9px 10px', border:`1.5px solid #86efac`, borderRadius:8, fontSize:14, fontWeight:700, fontFamily:'inherit', outline:'none', background:C.surface, color:C.navy }}/>
            </div>
            <div>
              ...
              <input type="number" value={addForm.sell_price} onChange={e=>setAddForm(f=>({...f,sell_price:e.target.value}))} placeholder="e.g. 2500"
                style={{ width:'100%', padding:'9px 10px', border:`1.5px solid #93c5fd`, borderRadius:8, fontSize:14, fontWeight:700, fontFamily:'inherit', outline:'none', background:C.surface, color:C.navy }}/>
            </div>
          </div>
          {addForm.buy_price && addForm.sell_price && (
            <div style={{ background:C.surface, borderRadius:8, padding:'8px 12px', marginBottom:10, fontSize:12 }}>
