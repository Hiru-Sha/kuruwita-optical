    ...
    <div style={{ background:C.cream, borderRadius:12, padding:'16px', marginTop:8 }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:8, marginBottom:14, fontSize:13 }}>
        {[
          ...
          <div key={row.l} style={{ background:C.surface, borderRadius:8, padding:'8px 10px' }}>
...
function SaleDetail({ sale }) {
  ...
  return (
    <div style={{ background:C.cream, borderRadius:12, padding:'16px', marginTop:8 }}>
      ...
      {/* Items */}
      <div style={{ background:C.surface, borderRadius:10, overflow:'hidden', marginBottom:8 }}>
  ...
  return (
    <div style={{ background:C.cream, borderRadius:12, padding:'16px', marginTop:8 }}>
      ...
      {(repair.description||repair.frame_description) && (
        <div style={{ background:C.surface, borderRadius:8, padding:'10px 12px', marginBottom:8, fontSize:13 }}>
...
export default function ActivityView() {
  ...
  const Row = ({ children, type, id, accent }) => {
    ...
    return (
      <div style={{ background:C.surface, border:`1.5px solid ${isOpen?accent||C.gold:C.border}`,
  ...
  return (
    <div style={{ fontFamily:'var(--font-body)' }}>
      ...
      <div style={{ marginBottom:16 }}>
        ...
        <h1 style={{ fontFamily:'var(--font-display)', fontSize:22, color:C.navy, margin:0 }}>
          {TITLE_MAP[viewMode]}
        </h1>
      </div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(130px,1fr))', gap:10, marginBottom:16 }}>
        ...
        {balanceDue > 0 && (
          <div style={{ background:'#fee2e2', border:'1px solid #fca5a5', borderRadius:12, padding:'12px 14px' }}>
            ...
            <div style={{ fontFamily:'var(--font-display)', fontSize:20, fontWeight:700, color:C.danger }}>{fmt(balanceDue)}</div>
          </div>
        )}
      </div>
      ...
      <div style={{ display:'flex', borderBottom:`1px solid ${C.border}`, marginBottom:16,
        background:C.surface, borderRadius:'12px 12px 0 0', overflowX:'auto' }}>
        {TABS.map(t=>(
